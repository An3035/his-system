...
async def asr_transcribe(audio_data: bytes, filename: str = "audio.webm") -> dict:
    ...
    try:
        ...
        _log("调用百炼官方fun-asr同步API...")
        response = await asyncio.to_thread(requests.post, headers=headers, json=payload, timeout=30)

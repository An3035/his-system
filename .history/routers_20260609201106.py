...
# 注册所有子路由（包含你报错的 admission_router）
api_router.include_router(auth_router)
api_router.include_router(reg_router)
api_router.include_router(patient_router)
api_router.include_router(pres_router)
api_router.include_router(pharm_router)
api_router.include_router(warehouse_router)
api_router.include_router(drug_router)
api_router.include_router(kiosk_router)
api_router.include_router(admission_router)  # ✅ 报错的路由在这里
